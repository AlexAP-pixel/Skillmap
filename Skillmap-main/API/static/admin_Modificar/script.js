...
btnEliminar = document.getElementById('eliminarUsuarioButton');
btnCambiar = document.getElementById('guardarCambiosButton');
...
try {
    ...
    if (endpoint === '/updateUsers') {
        if (userCorreo != correo) {
        try {
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (buscarUsuarios){
        buscarUsuarios.addEventListener('submit', function(event) {
            event.preventDefault();
            buscarUsuarios();
        });
    }
